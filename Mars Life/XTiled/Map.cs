...
namespace FuncWorks.XNA.XTiled {
    ...
    public class Map {
        ...
        /// <summary>
        /// Draws all visible tile layers in a scaled state
        /// </summary>
        ...
        public void DrawScaled(SpriteBatch spriteBatch, Rectangle region, float scale)
        {
            this.DrawScaled(spriteBatch, ref region, false, scale);
        }
        ...
        /// <summary>
        /// Draws all visible tile layers scaled
        /// </summary>
        /// <param name="spriteBatch">XNA SpriteBatch instance; SpriteBatch.Begin() must be called before using this method</param>
        /// <param name="region">Region of the map in pixels to draw</param>
        /// <param name="drawHiddenLayers">If true, draws layers regardless of TileLayer.Visible flag</param>
        public void DrawScaled(SpriteBatch spriteBatch, ref Rectangle region, Boolean drawHiddenLayers, float scale)
        {
            ...
            for (int l = 0; l < this.TileLayers.Count; l++)
            {
                if (this.TileLayers[l].Visible || drawHiddenLayers)
                {
                    DrawLayerScaled(spriteBatch, l, ref region, txMin, txMax, tyMin, tyMax, 0, scale);
                }
            }
        }
        ...
        private void DrawLayerScaled(SpriteBatch spriteBatch, Int32 layerID, ref Rectangle region, Int32 txMin, Int32 txMax, Int32 tyMin, Int32 tyMax, Single layerDepth, float scale)
        {
