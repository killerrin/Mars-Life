...
namespace Mars_Life
{
    public class CreditManager
    {
        ...
        public CreditManager(ContentManager content, GraphicsDevice graphics)
        {
            ...
            AddHeader("3D & 2D Artists");
            AddContent("Andrew Godfroy");
            AddSpacing();


            AddHeader("Music & Sound Effects");
            AddContent("Editing: Andrew Godfroy");
            AddContent("TechnoAxe: http://teknoaxe.com/");
            AddSpacing();

            AddHeader("Special Thanks");
            //AddContent("");
            AddContent("Tiled: http://www.mapeditor.org/");
            AddContent("XTile: https://bitbucket.org/vinull/xtiled/wiki/Home");
            ...
            AddSpacing();
            AddSpacing();
            AddCenteredImage(Game1.splashScreen.killerrinStudiosLogo);
